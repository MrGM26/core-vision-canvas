    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1571171637578-41bc2dd41cd2?w=1920&h=1080&fit=crop')",
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 text-center text-white">
          <div className="max-w-4xl mx-auto fade-in-up">
            ...
            <p className="text-xl sm:text-2xl text-off-white/90 mb-12 leading-relaxed max-w-3xl mx-auto">
              Promax Burkina Faso leads high-impact investment and project development across security, gold & mining,
              infrastructure, financial services, and energy — aligning with national priorities and regional
              opportunity.
            </p>
      ...
      <section id="who-we-are" className="py-16 bg-background">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center fade-in-up">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-primary mb-12">Our Story</h2>

            <div className="space-y-8 text-center">
              <p className="text-xl text-foreground/80 leading-relaxed">
                Promax Burkina Faso is a leading investment and business development company delivering strategic,
                high-impact projects across Burkina Faso and West Africa. We specialize in emerging markets and
                high-growth sectors including security, gold & mining, infrastructure, financial services, and energy
                solutions.
              </p>

              <p className="text-xl text-foreground/80 leading-relaxed">
                Operating closely with government entities, we provide a trusted gateway for foreign and local
                investors, development institutions, and strategic partners to engage in transformational opportunities
                aligned with Burkina Faso's national development plan.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-8 mt-12">
                ...
                <Card className="border-accent/20 card-hover">
                  ...
                  <CardContent>
                    <p className="text-foreground/80 text-center">
                      To unlock potential by delivering innovative, scalable, and economically empowering projects for
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16 fade-in-up">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-primary mb-6">Our Impact</h2>
              <p className="text-xl text-foreground/80 max-w-3xl mx-auto">
                Comprehensive investment and development services across key sectors driving Burkina Faso's economic
                transformation.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {sectors.map((sector, index) => (
                <Card
                  key={index}
                  className="card-tilt border-accent/20 group hover:shadow-2xl hover:shadow-accent/10 transition-all duration-300"
                >
                  <CardHeader>
                  ...
                  <CardContent>
                    <CardDescription className="text-foreground/70">{sector.description}</CardDescription>
                  </CardContent>
                </Card>
              ))}
            </div>
      ...
      <section id="impact" className="py-8 bg-background">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16 fade-in-up">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-primary mb-6">Shaping Tomorrow</h2>
              <p className="text-xl text-foreground/80 max-w-3xl mx-auto">
                Creating jobs, boosting investor confidence, and powering sustainable growth in Burkina Faso's emerging
                economy.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {impactItems.map((item, index) => (
                <Card
                  key={index}
                  className="group overflow-hidden border-accent/20 hover:shadow-2xl hover:shadow-accent/10 transition-all duration-300"
                >
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-10 fade-in-up">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-primary mb-6">Strategic Partnerships</h2>
              <p className="text-xl text-foreground/80 max-w-3xl mx-auto">
              ...
              <div className="fade-in-up">
                ...
                <div className="space-y-4">
                  {partners.map((partner, index) => (
                    <div
                      key={index}
                      className="flex items-center gap-4 p-4 bg-background rounded-lg border border-accent/20"
                    >
                ...
                <Card className="border-accent/20">
                  ...
                  <CardContent>
                    <p className="text-foreground/80 leading-relaxed mb-6">
                      Our Public-Private Partnership model ensures alignment with regulation, community needs, and
                      long-term sustainability across all our initiatives.
                    </p>
                    <Button
                      className="w-full bg-accent hover:bg-accent/90 text-accent-foreground font-semibold"
                      onClick={() =>
                        (window.location.href = "mailto:info@promax-bf.com?subject=PPP Collaboration Inquiry")
                      }
                    >
      ...
      <section id="contact" className="py-8 gradient-hero">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16 fade-in-up">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">Contact Us</h2>
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-accent/20">
                <CardContent className="p-8">
                  ...
                  <p className="text-white/90 leading-relaxed text-lg mb-4">
                    For partnership opportunities and investment discussions, please include details about your project
                    scope, timeline, and funding requirements in your message.
                  </p>
                  <p className="text-white/70 text-base">Promax United office details available upon request.</p>
                </CardContent>
              </Card>
            </div>
                ...
                <div className="fade-in-up">
                  <Card className="bg-white/10 backdrop-blur-sm border-accent/20">
                    <CardContent className="p-6">
                      ...
                      <p className="text-white/90 leading-relaxed text-sm mb-2">Monday - Friday: 8:00 AM - 6:00 PM</p>
                      <p className="text-white/90 leading-relaxed text-sm">Saturday: 9:00 AM - 2:00 PM</p>
                    </CardContent>
                  </Card>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <a href="tel:+971566010848" className="text-white/90 hover:text-accent transition-colors">
                          +971 56 601 0848
                        </a>
                      </div>
                    </div>
      ...
      <footer className="bg-primary text-white py-12">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-off-white/80 text-sm">© 2026 Promax Burkina Faso. All Rights Reserved.</p>
            <div className="flex gap-6 text-sm">
              <a href="#" className="text-off-white/80 hover:text-accent transition-colors">
                Legal Disclaimer
              </a>
              <a href="#" className="text-off-white/80 hover:text-accent transition-colors">
                Privacy Policy
